...
const productContext = React.createContext();
 ...
 class ProductProvider extends Component {
         ...
         state ={
             ...
             cart : this.localStorage("cart") ,
             openModal : false ,
             closeModal : false ,
             cartSubTotal : this.localStorage("cartSubTotal") ,
             cartTax : this.localStorage("cartTax") ,
             total : this.localStorage("total") ,
             counterCart : this.localStorage("counterCart"),
             loading : false
