...
const productContext = React.createContext();
 ...
 class ProductProvider extends Component {
         ...
         state ={
             products: this.setStorage("products") ,
             detail : DetailProduct ,
             cart : this.setStorage("cart") ,
             openModal : false ,
             closeModal : false ,
             cartSubTotal : this.setStorage("cartSubTotal") ,
             cartTax : this.setStorage("cartTax") ,
             total : this.setStorage("total") ,
             counterCart : this.setStorage("counterCart"),
             loading : false
    ...
    // }
      ...
      setStorage(value){
        return window.localStorage.getItem(value) ? JSON.arra(window.localStorage.getItem(value)):[];
