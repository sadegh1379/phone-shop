                ...
                {(value)=>{
                    ...
                    return(
                        ...
                        <div className="row my-1 pr-4 py-2 text-right mx-auto">
                                            ...
                                            <h6 className="text-muted">نظر کاربران <span className="fa fa-arrow-down  text-danger" style={{cursor:'pointer'}}></span></h6><br/>
                                            <ul className="list-group list-dark">
                                                <li className="list-group-item">awdaw</li>
                                                <li className="list-group-item">awdaw</li>
                                                <li className="list-group-item">awdawd</li>
                                            </ul>
