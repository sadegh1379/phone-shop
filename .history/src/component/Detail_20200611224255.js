                                ...
                                <div className="col-lg-6 text-right col-md-6 my-md-3 justify-content-between align-items-center my-sm-3  col-sm-10 py-4 px-5">
                                        ...
                                        <span className="text-muted">  رنگ بندی : 
                                             ...
                                             <span className=" float-left floatspan  ml-2">
                                                <span onClick={()=>changeColor(id , 'red')} className="btn btn-sm" style={{ backgroundColor: 'red' , color: 'red'}}>C</span>
                                                <span onClick={()=>changeColor(id , 'gold')} className="btn btn-sm mx-1" style={{ backgroundColor: 'gold' , color: 'gold'}}>C</span>
                                                <span onClick={()=>changeColor(id , 'red')} className="btn btn-sm " style={{ backgroundColor: 'black' , color: 'black'}}>C</span>
