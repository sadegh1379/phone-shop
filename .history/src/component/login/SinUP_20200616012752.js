             ...
             <div className="d-flex justify-content-center form_container">
                 <form onSubmit={this.handleSubmit} className="text-right">
                     ...
                     <div className="input-group mb-2">
                         ...
                         <input onChange={this.handleChange} type="text" maxlength="4" name="phone" className="form-control input_pass text-right" value={phone} required placeholder="شماره همراه"/>
                     </div>
                     <div className="input-group mb-2">
                         <div className="input-group-append">
