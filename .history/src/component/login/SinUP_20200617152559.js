         ...
         return(
             <UserConsumer>
                 {value=>{
                     ...
                     const {addUser , alert , push} = value;
                     
                     push? return this.props.history.push(push) : null
        ...
        return (
            ...
            <div dir="ltr"  className="container h-100 mt-4 login-h">
             ...
             <div className="d-flex justify-content-center form_container">
                 <form onSubmit={(e)=>this.handleSubmit(e , addUser , ...this.props)}  className="text-right ">
