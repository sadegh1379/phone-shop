             ...
             <div className="d-flex justify-content-center form_container">
                 <form className="text-right">
                     <div className="input-group mb-3">
                         ...
                         <input type="text" name="name" className="form-control input_user text-right" value="" placeholder="نام "/>
                     </div>
                     <div className="input-group mb-3">
                         <div className="input-group-append">
                             <span className="input-group-text"><i className="fa fa-user"></i></span>
                         </div>
                         <input type="text" name="lastName" className="form-control input_user-o text-right" value="" placeholder="نام خانوادگی "/>
                     </div>
                     <div className="input-group mb-2">
                         <div className="input-group-append">
                             <span className="input-group-text"><i className="fa fa-phone"></i></span>
                         </div>
                         <input type="text" name="pass_1" className="form-control input_pass text-right" value="" placeholder="شماره همراه"/>
                     </div>
                     <div className="input-group mb-2">
                         <div className="input-group-append">
                             <span className="input-group-text"><i className="fa fa-key"></i></span>
                         </div>
                         <input type="password" name="pass_2" className="form-control input_pass text-right" value="" placeholder="رمز ورود"/>
                     </div>
                     <div className="input-group mb-2">
                         <div className="input-group-append">
                             <span className="input-group-text"><i className="fa fa-key"></i></span>
