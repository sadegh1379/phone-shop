 ...
 class SinIn extends Component {
    ...
    handleSubmit = (e , func)=>{
		...
		e.preventDefault();
			...
			// console.log(login);
			if(login){
				setTimeout(()=>this.props.history.push('/pro') , 3000)
			}
				 ...
				 <div className="d-flex justify-content-center h-100">
					 <div className="user_card">
						 ...
						 <div className="d-flex justify-content-center form_container">
							 ...
							 <form className="text-right" onSubmit={(e)=>this.handleSubmit(e,userSinIn)}>
							 {
                                      alert.text? <div style={{fontSize:'12px' }} className={`alert text-center my-2 alert-${alert.color}`} role="alert">
                                      {alert.text}
                                     </div> : null
                                  } 
							  ...
							  <button type="submit" name="button" className="btn login_btn">ورود</button>
							</div>
