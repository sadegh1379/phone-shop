             ...
             <div className="d-flex justify-content-center form_container">
                 <form onSubmit={this.handleSubmit} className="text-right">
                     ...
                     <div className="input-group mb-2">
                         ...
                         <input onChange={this.handleChange} maxlength="4" type="password" name="pass_2" className="form-control input_pass text-right" value={pass_2} required placeholder=" تکرار رمز ورود "/>
                     </div>
