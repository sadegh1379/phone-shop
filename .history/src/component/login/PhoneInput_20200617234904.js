          ...
          <div className="col-10 col-md-5  text-center mx-auto text-right">
            <form>
                    <div className="form-group">
                        ...
                        <input type="text" pattern= value={value} onChange={(e)=>setValue(e.target.value)} required className="form-control form-control-lg text-center" id="formGroupExampleInput" />
                    </div>
