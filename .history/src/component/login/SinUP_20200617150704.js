...
export class SinUP extends Component {
    ...
    render() {
       ...
       const {name , lastName , phone , pass_1 , pass_2 , location} = this.state ;
         return(
             <UserConsumer>
                 {value=>{
             ...
             <div className="d-flex justify-content-center form_container">
                 <form onSubmit={(e)=>this.handleSubmit(e , addUser)}  className="text-right ">
                     ...
                     <div className="input-group my-3">
                         ...
                         <input onChange={this.handleChange} type="telephone" maxLength="11" name="phone" className="form-control input_pass text-right" value={phone} required placeholder="شماره همراه"/>
                     </div>
                     <div className="input-group my-3">
                         <div className="input-group-append">
