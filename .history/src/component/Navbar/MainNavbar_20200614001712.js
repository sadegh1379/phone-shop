                ...
                <nav className="navbar  navbar-expand-sm  navbar-dark bg-dark text-center">
                    ...
                    <div className="collapse navbar-collapse mr-4" id="navbarNavDropdown">
                        ...
                        <li className="nav-item dropdown ">
                            ...
                            <a className="dropdown-item" style={{fontSize:'13px'}} href="#">عملکرد <span className="fa fa-user-o mx-2"></span></a>
                            <a className="dropdown-item " style={{fontSize:'13px'}} href="#">مشخصات</a>
