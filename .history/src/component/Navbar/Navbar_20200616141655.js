    ...
    return (
        <React.Fragment>
                    <nav className="navbar  bg-danger  navbar-light">
                     <a href="/" className="navbar-brand mr-0 " alt="a"><h6><span className="fa pl-2 fa-2x fa-user-o text-light "></span> 
                     <UserConsumer>
                         {value=>{
                             return(
                                value.sinUp ? (<span class="badge badge-warning">Warning</span><span className="fa fa-heart-o"></span>) : null
                             )
                         }}
                     </UserConsumer>
