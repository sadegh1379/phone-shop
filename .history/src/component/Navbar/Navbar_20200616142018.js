    ...
    return (
        <React.Fragment>
                    <nav className="navbar  bg-danger  navbar-light">
                     <a href="/" className="navbar-brand mr-0 " alt="a"><h6>
                     <UserConsumer>
                         {value=>{
                             return(
                                value.sinUp ? (<span className="fa pl-2 fa-2x fa-user-o text-success "></span> ) : <span className="fa pl-2 fa-2x fa-user-o text-light "></span> 
                             )
                         }}
                     </UserConsumer>
