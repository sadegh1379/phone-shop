                ...
                <nav className="navbar  navbar-expand-sm  navbar-dark bg-dark text-center">
                    ...
                    <div className="collapse navbar-collapse mr-4" id="navbarNavDropdown">
                        ...
                        <li className="nav-item dropdown ">
                            ...
                            <a className="dropdown-item" style={{fontSize:'13px'}} href="#"> <span className="fa fa-user-o mم-2"></span>عملکرد</a>
                            <a className="dropdown-item " style={{fontSize:'13px'}} href="#"><i class="fa fa-address-card-o" aria-hidden="true"></i>مشخصات</a>
