                ...
                <nav className="navbar  navbar-expand-sm  navbar-dark bg-dark text-center">
                    ...
                    <div className="collapse navbar-collapse mr-4" id="navbarNavDropdown">
                        ...
                        <li className="nav-item dropdown ">
                            ...
                            <div className="dropdown-menu text-right bg-info  dropdown-menu-left" aria-labelledby="navbarDropdownMenuLink">
                            <a className="dropdown-item" style={{fontSize:'13px'}} href="#">عملکرد</a>
                            <a className="dropdown-item" href="#">مشخصات</a>
                            <a className="dropdown-item" href="#">بیشتر...</a>
                            </div>
                        </li>
                        </ul>
                    </div>
