                ...
                {(value)=>{
                    ...
                    return(
                        ...
                        <div className="row  p-3 mx-auto text-center">
                                            ...
                                            <div>
                                                <ul className="list-group list-group-flush py-3 " style={{width:'100%'}}>
                                                <h6 className="text-muted">نظر کاربران <span className="fa fa-arrow-down  text-danger" style={{cursor:'pointer'}}></span></h6>
                                                {
                                                    comments  ? comments.map((com)=>{
                                                        return <li className="list-group-item list-group-item-dark py-3 px-1 text-right cost">
                                                                    <h5 className="float-right text-danger">{com.name}</h5>
                                                                    <h6 className="float-left text-muted">{com.text}</h6>
                                                            </li>
                                                    }) : null
                                                }
                                                </ul>
