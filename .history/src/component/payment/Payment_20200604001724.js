...
function Payment() {
    ...
    const [one , setQOne] = useState(false);
    const [qTow, setQTow] = useState(false);
    return (
        <div className="container my-3 row mx-auto">
            <div className="card col-10 card-info mx-auto  py-3 px-3">
                ...
                <a href="https://me.sizpay.ir/sadeghpay" className="btn btn-block btn-success mt-3">
                        پرداخت
                    </a>
            </div>
        </div>
