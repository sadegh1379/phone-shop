...
function Product(props) {
    ...
    return (
        ...
        <div className="col-11 col-lg-4 col-md-6  text-center wow bounceInUp justify-content-center mx-auto py-1"
        ...
        >
               <div className="card card-p card-hover py-3">
                    ...
                    <div className="card-body">
                        <p className="muted card-text cost">{addCama(price)} <span className="h6 text-danger muted">تومان</span></p>
                    </div>
               </div>
