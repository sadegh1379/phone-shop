            ...
            <div class="row text-center ">
              ...
              <div class="col-md-4 mx-auto footer-i">
                ...
                <ul class="list-unstyled">
                  <li>
                    <span className="fa fa-telegram text-info p-1"></span><a href="https://www.instagram.com/_.sadegh79/">Telegram</a>
                  </li>
                  <li>
                    <span className="fa fa-instagram text-danger p-1"></span><a href="#!">Instagram</a>
                  </li>
                  <li>
                     <span className="fa fa-chrome text-info p-1"></span><a href="#!">WebSite</a>

                  </li>
                  <li>
                    <span className="fa fa-github text-info p-1"></span><a href="#!">Github</a>
                  </li>
                </ul>
