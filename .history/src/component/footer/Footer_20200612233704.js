          ...
          <div class="container text-center text-md-left">
            ...
            <div class="row text-center ">
              ...
              <div class="col-md-4 mx-auto">
                ...
                {/* <!-- Links --> */}
                <h5 class="font-weight-bold text-uppercase mt-3 mb-4">پرسش های متداول</h5>
                ...
                <ul class="list-unstyled">
                  ...
                  <li>
                    <a href="#!" style={{fontSize:'13px' , lineHeight:'26px'}}>Link 3</a>
                  </li>
                  <li>
                    <a href="#!" style={{fontSize:'13px' , lineHeight:'26px'}}>Link 4</a>
                  </li>
                </ul>
