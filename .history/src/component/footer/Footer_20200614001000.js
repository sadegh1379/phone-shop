    ...
    return (
        ...
        <footer dir="rtl" data-wow-dely="2s" data-wow-duration="1s"  className=" wow bounceInUp page-footer font-small stylish-color-dark pt-4">
            ...
            <div className="row text-center ">
              ...
              <div className="col-md-4 mx-auto footer-q">
                ...
                <ul className="list-unstyled text-right">
                  ...
                  <li>
                    <a href="#!" style={{fontSize:'13px' , lineHeight:'26px'}}>برای خرید و انتخاب کالا در سایت نباز به مشاوره دارم راهی وجود دارد؟</a>
                  </li>
                </ul>
          ...
          <ul className="list-unstyled buttons list-inline text-center ">
            <li data-wow-dely="2s" data-wow-duration="1s" className="list-inline-item wow bounceInLeft">
              <a className="btn-floating btn-fb mx-1">
                <i className="fa fa-facebook-f"> </i>
              </a>
            </li>
            <li data-wow-dely="2s" data-wow-duration="2s" className="list-inline-item wow bounceInLeft">
              <a className="btn-floating btn-tw mx-1">
                <i className="fa fa-twitter"> </i>
              </a>
            </li>
            <li data-wow-dely="3s" data-wow-duration="3s" className="list-inline-item wow bounceInLeft" >
              <a className="btn-floating btn-gplus mx-1">
                <i className="fa fa-google-plus"> </i>
              </a>
            </li>
            <li data-wow-dely="3s" data-wow-duration="4s" className="list-inline-item wow bounceInLeft">
              <a className="btn-floating btn-li mx-1">
                <i className="fa fa-linkedin"> </i>
              </a>
            </li>
            <li data-wow-dely="3s" data-wow-duration="5s" className="list-inline-item wow  bounceInLeft">
          ...
          {/* <!-- Copyright --> */}
          <div className="footer-copyright text-center py-3 down">© 2020 designed by:
