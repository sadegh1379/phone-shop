    ...
    return (
        ...
        <footer dir="rtl" data-wow-dely="2s" data-wow-duration="1s"  className=" wow bounceInUp page-footer font-small stylish-color-dark pt-4">
          ...
          <div className="container text-center text-md-left">
            ...
            <p className="cost l" style={{fontSize:'13px' , lineHeight:'26px'}}>تمامی کالا ها و خدمات این فروشگاحسب مورد دارای مجوز های لازم از مراجع مربوط میباشد و فعالیت های این سایت تابع قوانین و مقررات جمهوری اسلامی ایران است</p>
