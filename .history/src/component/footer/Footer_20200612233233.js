          ...
          <div class="container text-center text-md-left">
            ...
            <div class="row text-center ">
              ...
              <div class="col-md-2 mx-auto">
                ...
                {/* <!-- Links --> */}
                <h5 class=" mt-3 mb-4 " style={{fontSize:'13px' , lineHeight:'26px'}}>پرسش های متداول</h5>
        
                <ul class="list-unstyled">
                  <li>
                    <a style={{fontSize:'13px' , lineHeight:'26px'}} href="#!">از وضعیت سفارشی که ثبت کرده ام چگونه میتونم مطلع شوم؟</a>
                  </li>
                  <li>
                    <a href="#!">Link 2</a>
                  </li>
