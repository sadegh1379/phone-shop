    ...
    return (
        ...
        <footer dir="rtl" data-wow-dely="2s" data-wow-duration="1s"  className=" wow bounceInUp page-footer font-small stylish-color-dark pt-4">
          ...
          <ul className="list-unstyled buttons list-inline text-center ">
            ...
            <li data-wow-dely="1s" data-wow-duration="2s" className="list-inline-item wow bounceInLeft">
            ...
            <li data-wow-dely="2s" data-wow-duration="4s" className="list-inline-item wow bounceInLeft">
              <a className="btn-floating btn-li mx-1">
                <i className="fa fa-linkedin"> </i>
              </a>
            </li>
            <li data-wow-dely="2s" data-wow-duration="5s" className="list-inline-item wow  bounceInLeft">
