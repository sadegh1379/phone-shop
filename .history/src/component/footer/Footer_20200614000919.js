    ...
    return (
        ...
        <footer dir="rtl" data-wow-dely="2s" data-wow-duration="1s"  className=" wow bounceInUp page-footer font-small stylish-color-dark pt-4">
          ...
          <ul className="list-unstyled buttons list-inline text-center ">
            ...
            <li data-wow-dely="4s" data-wow-duration="1s" className="list-inline-item wow bounceInLeft" >
              <a className="btn-floating btn-gplus mx-1">
                <i className="fa fa-google-plus"> </i>
              </a>
            </li>
            <li data-wow-dely="5s" data-wow-duration="1s" className="list-inline-item wow bounceInLeft">
              <a className="btn-floating btn-li mx-1">
                <i className="fa fa-linkedin"> </i>
              </a>
            </li>
            <li data-wow-dely="6s" data-wow-duration="1s" className="list-inline-item wow  bounceInLeft">
