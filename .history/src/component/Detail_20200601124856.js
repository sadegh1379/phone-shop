                ...
                {(value)=>{
                    ...
                    return(
                        <div className="row text-center d-flex   my-3 py-2 ">
                                ...
                                <div className="col-lg-6 text-right col-md-6 my-md-3 justify-content-center align-items-center my-sm-3  col-sm-10 p-4">
                                        <h3 className="text-dark">{title}</h3><hr className="text-light mx-4"/>
                                         <span className="text-muted ">قیمت </span><span className="text-left">{price} تومان</span>
