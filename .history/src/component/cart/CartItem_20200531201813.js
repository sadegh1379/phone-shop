...
function CartItem(props) {
    ...
    return (
            <div style={styled} className=" py-4 row d-flex text-center justify-content-center my-4">
                        ...
                        <div className="col-lg-6 text-center mx-auto  col-md-12 py-md-4">
                                <strong className="py-md-4 py-sm-4">{title}</strong><hr className="bg-white"/>
                                <div className="card text-right card-body card-dark bg-dark text-white my-md-4 my-sm-4 my-sm-4 mx-auto">
