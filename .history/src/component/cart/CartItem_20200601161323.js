    ...
    return (
            <div style={styled} className="  row d-flex text-center justify-content-center my-4">
                        ...
                        <div className="col-lg-6 text-center mx-auto  col-md-12 py-md-4 my-xs-4">
                                ...
                                <div className="card text-right card-body card-dark   my-md-4 my-sm-4 my-xs-4 mx-auto">
                        ...
                        <div className="col-lg-6 mt-md-4 mt-sm-4 mt-sx-4  col-md-12 align-items-center d-flex justify-content-center" >
                           <Link to="/detail"
