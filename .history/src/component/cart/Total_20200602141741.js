        ...
        <div className="container py-3">
            <div className="row">
                    ...
                    <h3 className="text-dark text-center">پرداخت</h3><hr className="text-light  my-4"/>
                            ...
                            <h6>
                                    <span className="text-muted "> مبلغ : </span><span className="text-danger float-left">{s} تومان</span>
                            </h6>
                            ...
                            <h6 className="my-3">
                            <span className="text-muted">  مبلغ قابل پرداخت  : </span><span className=" float-left h5">{company} </span>
                            </h6> 
