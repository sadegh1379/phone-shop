...
function CartItem(props) {
    ...
    const {img , title , info , id , total , price , count } = props.product;
    ...
    return (
            <div style={styled} className=" py-4 row d-flex text-center justify-content-center my-4">
                        <div className="col-lg-6 text-center  col-md-12 py-md-4">
                                ...
                                <div className="card card-body card-dark bg-dark my-md-4 my-sm-4 mx-auto">
                                <h6 className="my-3"> Price : {price} <span className="mx-1 ">$</span></h6>
                                        <h5>
                                                {info}
                                        </h5>
                                </div>
