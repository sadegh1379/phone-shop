            ...
            >
                        ...
                        <div className="col-lg-6 text-center mx-auto  col-md-12 py-md-4 my-xs-4">
                                ...
                                <div style={{width:'80%'}} className="card text-right card-body card-dark    my-md-4 my-sm-4 my-xs-4 mx-auto">
                                                        ...
                                                        <h6>
                                                                <span className=" "> قیمت  </span><span className="text-danger cost float-left">{addCama(price)} تومان</span>
                                                        </h6>
                                                        <h6 className="my-3">
                                                ...
                                                >{(count > 1) ? "-" : <span className="fa fa-trash"></span>
                                                }</button>                            
                                                </span> 
                                                
                                                </span>
                                                <h6 className="my-3">
                                                        <span className=" "> مبلغ قابل پرداخت  </span><span className="text-danger cost float-left">{addCama((price * count))} تومان</span>
                                                 </h6> 
                                </div>
                                
                        </div>
                        
                        <div className="col-lg-6 mt-md-4 mt-2 d-lg-block d-md-block d-sm-none d-xs-none   col-md-12 align-items-center d-flex justify-content-center" >
                           <Link to="/detail"
