        ...
        <div className="container py-3">
            ...
            >
                    ...
                    <h3 className="text-dark text-center">پرداخت</h3><hr className="text-light  my-4"/>
                            ...
                            <h6 className="my-3">
                            <span className="text-muted"> قیمت کل   : </span><span className=" float-left h5 cost">{addCama(subTotal)} </span>
                            </h6> 

                            <h6 className="my-3">
                            <span className="text-muted"> هزینه ی پست : </span><span className=" float-left h5 cost">{addCama(tax)} </span>
                            </h6> 
                          
                            <h6>
                                    <span className="text-muted "> مبلغ قابل پرداخت : </span><span className="text-danger cost float-left">{addCama(total)} تومان</span>
                            </h6>
                            <h6 className="my-3">
