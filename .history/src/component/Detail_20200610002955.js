        ...
        return (
            <ProductConsumer>
                {(value)=>{
                    ...
                    return(
                        <>
                        <div className="row text-center d-flex wow bounceInRight  my-0 py-1 " data-wow-dely="3s" data-wow-duration="2s">
                        ...
                        <div className="row  p-3 mx-auto text-center">
                                                ...
                                                <ul className="list-group list-group-flush py-3 cost transition" style={{width:'100%'}}>
                                                ...
                                                { 
                                                    comments && this.state.open   ? comments.map((com , index)=>{
                                                        return <li key={index} className="list-group-item list-group-item-dark py-3 wow bounceInLeft  px-1 text-right"
                                                        data-wow-dely="3s" data-wow-duration="2s"
                                                        >
