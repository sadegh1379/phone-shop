                ...
                {(value)=>{
                    ...
                    return(
                        ...
                        <div className="row  p-3 mx-auto text-center">
                                                ...
                                                <h6 className="text-muted align-items-center d-flex">نظر کاربران </h6><span
                                                onClick={this.handleOpen}
                                                className={`fa  fa-chevron-circle-${this.state.open ? 'up' : 'down'}  text-warning`} style={{cursor:'pointer'}}></span>
