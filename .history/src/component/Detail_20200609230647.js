                                            ...
                                            <div className="py-3 ">
                                                ...
                                                <h6 className="text-muted">نظر کاربران <span className="fa fa-arrow-down  text-danger" style={{cursor:'pointer'}}></span></h6>
                                                {
                                                    comments  ? comments.map((com)=>{
                                                        return <li className="list-group-item list-group-item-dark py-3 px-1 text-right">
                                                                    <h5 className="float-right text-danger">{com.name}</h5><br/>
                                                                    <p className="float-center text-muted">{com.text}</hp6>
                                                            </li>
                                                    }) : null
                                                }
                                                </ul>
